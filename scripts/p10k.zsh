...
() {
  ...
  typeset -g POWERLEVEL9K_MY_USER_FOREGROUND=15
  typeset -g POWERLEVEL9K_MY_USER_BACKGROUND=31
  typeset -g POWERLEVEL9K_MY_HOST_FOREGROUND=220
  typeset -g POWERLEVEL9K_MY_HOST_BACKGROUND=166
  ...
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    ...
    '/'       ROOT     ''
    '*'       DEFAULT  '')
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='%F{196} %F{252} '
  typeset -g POWERLEVEL9K_DIR_HOME_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_HOME_S_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_HOME_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='%F{196} '
  typeset -g POWERLEVEL9K_DIR_HOME_S_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='%F{196}'
  typeset -g POWERLEVEL9K_DIR_HOME_O_VISUAL_IDENTIFIER_EXPANSION='%F{40} '
  typeset -g POWERLEVEL9K_DIR_HOME_O_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='%F{208} '
  typeset -g POWERLEVEL9K_DIR_ROOT_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_ROOT_PATH_SEPARATOR=' '
  typeset -g POWERLEVEL9K_DIR_ROOT_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_ROOT_NOT_WRITABLE_PATH_SEPARATOR='%F{196} '
  ...
  _init_container() {
    [[ -n $P9K_CONTAINER ]] && return
    typeset -gix P9K_CONTAINER=0
    if [[ -n $container ]]; then
      P9K_CONTAINER=1
